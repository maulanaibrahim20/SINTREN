    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="services_box_main">
                    <div class="services_box text_align_left">
                        <figure><img src="{{ url('/landing') }}/images/service1.jpg" alt="#" /></figure>
                        <div class="veget">
            ...
            <div class="col-md-4">
                <div class="services_box_main">
                    <div class="services_box text_align_left">
                        <figure><img src="{{ url('/landing') }}/images/service2.jpg" alt="#" /></figure>
                        <div class="veget">
            ...
            <div class="col-md-4">
                <div class="services_box_main">
                    <div class="services_box text_align_left">
                        <figure><img src="{{ url('/landing') }}/images/service3.jpg" alt="#" /></figure>
                        <div class="veget">
