<div class="news">
    <div class="container">
        ...
        <div class="row">
            <div class=" col-md-4">
                <div class="latest">
                    <figure><img src="{{ url('/landing') }}/images/news1.jpg" alt="#" /></figure>
                    ...
                    <div class="nostrud">
                        ...
                        <p>has a more-or-less normal distribution of letters, as opposed to using 'Content here,
                            content here', making iteditors </p>
            ...
            <div class=" col-md-4">
                <div class="latest box_desho">
                    <figure><img src="{{ url('/landing') }}/images/news2.jpg" alt="#" /></figure>
                    <span>15<br> March</span>
                    <div class="nostrud">
                        <h3>Alteration in somer</h3>
                        <p>has a more-or-less normal distribution of letters, as opposed to using 'Content here,
            ...
            <div class=" col-md-4">
                <div class="latest">
                    <figure><img src="{{ url('/landing') }}/images/news3.jpg" alt="#" /></figure>
                    <span>15<br> March</span>
                    <div class="nostrud">
                        <h3>Alteration in somer</h3>
                        <p>has a more-or-less normal distribution of letters, as opposed to using 'Content here,
