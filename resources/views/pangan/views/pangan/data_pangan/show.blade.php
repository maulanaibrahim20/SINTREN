                    ...
                    <div class="table-responsive">
                        <table class="table table-striped" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>{{ $laporanpangan->user ? $laporanpangan->user->name : 'N/A' }}</td>
                            </tr>
                            <tr>
                                <td class="text-right">Pasar</td>
                                <td>:</td>
                                <td>{{ $laporanpangan->pasar ? $laporanpangan->pasar->name : 'N/A' }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped" style="width: 100%">
                            <tr>
                                ...
                                <td>:</td>
                                <td>{{ $laporanpangan->jenis_pangan ? $laporanpangan->jenis_pangan->name : 'N/A' }}</td>
                            </tr>
                            <tr>
