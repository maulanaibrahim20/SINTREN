...
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default"
    data-as{{ url('/assets') }}-path="{{ url('/assets') }}/" data-template="vertical-menu-template-no-customizer">
...
<body>
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            ...
            <h1 class="mb-4 mx-2">@yield('code')</h1>
            <p class="mb-4 mx-2">Oops! 😖 @yield('message')</p>
