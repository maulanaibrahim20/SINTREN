                ...
                <div class="card-body">
                    ...
                    <div class="py-4 position-relative">
                        ...
                        <div class="mt-5 d-sm-flex align-items-center">
                            <div>
                                <h3 class="fw-semibold mb-1">{{ $pertanian->user->name }}</h3>
                                <p class="mb-0 fw-semibold text-muted-dark">Alamat : {{ $pertanian->alamat }}</p>
                                <div class="mb-2">
                                    <span
                                        class="badge badge-light fw-semibold text-dark fs-12 me-2">{{ $pertanian->user->getAkses->name }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active p-0" id="style6tab2">
                            <div class="card overflow-hidden border-0">
                                <div class="card-body">
                                    <form action="{{ url('/pertanian/pengaturan/editProfile/' . $pertanian->id) }}"
                                            ...
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" name="nama"
                                                        placeholder="Masukan Nama" value="{{ $pertanian->user->name }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" name="username"
                                                        ...
                                                        value="{{ $pertanian->user->username }}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" name="email"
                                                        placeholder="Masukan Email" value="{{ $pertanian->user->email }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" name="pekerjaan"
                                                        value="{{ $pertanian->user->getAkses->name }}" readonly disabled>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" name="no_telp"
                                                        placeholder="phone number" value="{{ $pertanian->no_telp }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="form-control" name="alamat" rows="2">{{ $pertanian->alamat }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <div class="tab-pane p-0" id="style6tab3">
                            <div class="card overflow-hidden border-0">
                                <div class="card-body">
                                    <form action="{{ url('/pertanian/pengaturan/editPassword/' . $pertanian->id) }}"
                                        method="POST" class="form-horizontal" enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
                                        <div class="d-flex">
