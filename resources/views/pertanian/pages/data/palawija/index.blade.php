            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="dropdown ms-auto">
                        ...
                        @else
                            <form style="display: inline;" action="{{ url('/pertanian/data_palawija/exportPdf') }}"
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <form action="{{ url('/pertanian/data_palawija/filter') }}" method="POST">
                            @csrf
                                    ...
                                    @foreach ($laporanPalawija as $data)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ url('/pertanian/data_palawija/show/' . $data->id) }}"
                                ...
                                @else
                                    @foreach (session('filtering') as $filter)
                                        <tr>
                                            ...
                                            <td>{{ $filter->nilai }}</td>
                                            <td class="text-center">
                                                <a href="{{ url('/pertanian/data_palawija/show/' . $filter->id) }}"
                                                    class="btn btn-primary">
                                                    <i class="ti ti-eye"></i></a>
                                            </td>
                                        </tr>
