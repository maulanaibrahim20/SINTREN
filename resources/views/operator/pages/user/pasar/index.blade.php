...
@section('content')
    <div class="page-header d-sm-flex d-block">
        <ol class="breadcrumb1 br-7">
            ...
            <div>
                <a href="{{ url('/operator/user/pasar/create') }}" class="btn bg-primary-transparent">
                    <span>
                                ...
                                @foreach ($users as $data)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('/operator/user/pasar/' . encrypt($data->id) . '/edit') }}"
                                                class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                            <a href="{{ url('/operator/user/pasar/' . encrypt($data->id)) }}"
                                                class="btn btn-primary">
                                                <i class="ti ti-eye"></i></a>
                                            <form id="deleteForm{{ $data->id }}"
                                                action="{{ url('/operator/user/pasar/' . $data->id) }}"
