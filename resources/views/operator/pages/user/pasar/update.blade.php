        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ url('/operator/user/pasar') }}" method="post" class="needs-validation"
                    novalidate>
                    @csrf
                    <div class="form-row">
                    ...
                    <a href="{{ url('/operator/create/data_pangan') }}" class="btn ripple btn-warning mr-2">Cancel</a>
