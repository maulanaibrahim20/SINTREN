@extends('index')
@section('title', 'Create User Pertanian | Operator')
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div
            ...
            <h5 class="card-title mb-sm-0 me-2"><span class="text-muted fw-light">Pengguna UPTD /</span> Create Pengguna
                UPTD
            </h5>
        </div>
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ url('/operator/user/uptd') }}" method="post" id="formValidationExamples"
