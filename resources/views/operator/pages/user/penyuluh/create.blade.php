...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div
            ...
            <h5 class="card-title mb-sm-0 me-2"><span class="text-muted fw-light">Pengguna Penyuluh /</span> Create Pengguna
                Penyuluh
            </h5>
        </div>
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ url('/operator/user/penyuluh') }}" method="post" id="formValidationExamples"
