...
class PetugasPasarController extends Controller
{
    protected $user;
    ...
    public function index()
    {
        ...
        return view('operator.pages.user.pasar.index', $data);
    }
    ...
    */
    public function create()
    {
        ...
        return view('operator.pages.user.pasar.create', $data);
    }
    ...
    */
    ...
    public function store(CreateRequest $request)
    {
        try {
            ...
            return redirect('/operator/user/pasar')->with('success', 'User Pasar Berhasil Ditambahkan!');
        } catch (\Exception $er) {
            DB::rollback();
    ...
    */
    public function show($id)
    {
        ...
        return view('operator.pages.user.pasar.show', $data);
    }
    ...
    */
    public function edit($id)
    {
        ...
        return view('operator.pages.user.pasar.update', $data, compact('user', 'pasar'));
    }
    ...
    */
    public function update(UpdatedRequest $request, $id)
    {
        try {
            ...
            return redirect('/operator/user/pasar')->with('success', 'Pengguna Pasar Berhasil Diubah!');
