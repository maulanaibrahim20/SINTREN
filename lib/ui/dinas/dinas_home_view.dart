...
class DinasHomeView extends StatefulWidget {
  const DinasHomeView({super.key});

  @override
  State<DinasHomeView> createState() => DinasHomeViewState();
}

class DinasHomeViewState extends State<DinasHomeView>
          ...
          if (presentasePenyuluhan! > 0) ...[
            ...
            Container(
              ...
              child: TabBarView(
                ...
                children: [
                  // Tab untuk data Padi
                  ProgressChart().buildProgressChartTab('Padi'),
                  // Tab untuk data Palawija
                  ProgressChart().buildProgressChartTab('Palawija'),
                ],
              ),
            ),
          ],
