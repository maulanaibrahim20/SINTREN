...
import 'package:sintren_mobile/ui/dinas/dinas_detail_desa_view.dart';

class DinasDesaView extends StatefulWidget {
  const DinasDesaView({super.key, this.kecamatanId});

  final String? kecamatanId;

  @override
  State<DinasDesaView> createState() => _DinasDesaViewState();
}

class _DinasDesaViewState extends State<DinasDesaView> {
