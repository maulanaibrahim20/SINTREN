...
class TanamPadiView extends StatefulWidget {
  const TanamPadiView({super.key});

  @override
  State<TanamPadiView> createState() => _TanamPadiViewState();
}

class _TanamPadiViewState extends State<TanamPadiView> {
  @override
