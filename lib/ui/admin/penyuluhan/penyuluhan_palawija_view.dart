...
class PenyuluhanPalawijaView extends StatefulWidget {
  const PenyuluhanPalawijaView({super.key});

  @override
  State<PenyuluhanPalawijaView> createState() => PenyuluhanPalawijaViewState();
}

class PenyuluhanPalawijaViewState extends State<PenyuluhanPalawijaView> {
  @override
