...
class PenyuluhanPadiView extends StatefulWidget {
  ...
  @override
  State<PenyuluhanPadiView> createState() => PenyuluhanPadiViewState();
}

class PenyuluhanPadiViewState extends State<PenyuluhanPadiView> {
  @override
                                  ...
                                  children: [
                                    ...
                                    ElevatedButton.icon(
                                      ...
                                      icon: const Icon(Icons.cancel_outlined,
                                          color: Colors.red),
                                      label: Text('Batalkan Verifikasi',
                                          style: StyleTheme()
                                              .stylePrimary
                                              .copyWith(
                                                  fontSize: 14,
