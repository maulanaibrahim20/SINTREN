...
class HomeVerifyWidget extends StatefulWidget {
  const HomeVerifyWidget({super.key});

  @override
  State<HomeVerifyWidget> createState() => _HomeVerifyWidgetState();
}

class _HomeVerifyWidgetState extends State<HomeVerifyWidget> {
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "${item.type == "Padi" ? dataPadi?.nilai ?? 0 : dataPalawija?.nilai ?? 0} hektar",
                                  style: StyleTheme().styleBlack.copyWith(
                                        fontSize: 14,
