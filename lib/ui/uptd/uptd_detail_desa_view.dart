...
class UptdDetailDesaView extends StatefulWidget {
  const UptdDetailDesaView({super.key, this.desaId, this.desaName});

  final String? desaId;
  final String? desaName;

  @override
  State<UptdDetailDesaView> createState() => _UptdDetailDesaViewState();
}

class _UptdDetailDesaViewState extends State<UptdDetailDesaView>
